...
#adding to the package a function to calculate reliability and give the files the names
#reliability, r shiny

#NEXT STEPS
#converting the files from csv to excel and then we would run all of the other
#files
#for one exmaple, we have tactile, auditory, visual
#if we coded for sensitive responding and another different code

#Future Steps
#we tell the program x, y, z and the function will
#change to accomodate x, y, z


#'Markov chain currently does first order predictions, second order, third order

#TODO Jan 26
#email overview of what function changes would look like and potential future function capabilities
#get the package into github successfully, no missing functions
#2nd and 3rd order entropy functions (one function, changing parameters)
#meet next week to figure out reliability function, how to incorporate into the package
