...
if (me == "glorgakker\\erettig") {
  wd <- "C:/Users/erettig/Google Drive/Reliability R Project/"
} else if (me == "ad3\\eugarte") {
  wd <- "T:\\Unpredictability Video Coding Project\\Montreal Exported CSV files\\Final Files"
}
#setwd(wd)
